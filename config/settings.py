...
SECRET_KEY = os.environ.get(
    'django-insecure-hs*n1eukd1akxma3#u8v-)=c&+u*^ej+68-rl^s+-azj*&*x-@',
...
INSTALLED_APPS = [
    ...
    # 'whitenoise.runserver_nostatic',  # ← ADD THIS - Must be before staticfiles
...
# CSRF Trusted Origins - ADD THIS for Render
